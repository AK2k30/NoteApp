...
import com.example.noteapp.NoteApp.NotesClickListener;
...
public class MainActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
    ...
    private void fliter(String newText) {
        List<Notes> fliterList = new ArrayList<>();
        for (Notes singleNote : notes){
            ...
            {
                fliterList.add(singleNote);
            }
        }
         notesListAdapter.fliterList(fliterList);
    }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.delete:
                ...
                notesListAdapter.notifyDataSetChanged();
                Toast.makeText(MainActivity.this, "Notes is been deleted!!", Toast.LENGTH_SHORT).show();
                return true;
            default:
                return false;
        }
